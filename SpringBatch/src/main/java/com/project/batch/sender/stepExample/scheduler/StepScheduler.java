package com.project.batch.sender.stepExample.scheduler;
...
@Slf4j
@Component
@ConditionalOnProperty(name = "step.enabled", havingValue = "true")
public class StepScheduler implements Scheduler {

    protected final JobLauncher jobLauncher;
    protected final Job jobName;
    protected final String jobCheckId = "StepJob";
    ...
    public StepScheduler(
            ...
            Job stepInterfaceJob,
            AbstractAutoService abstractAutoService
    ){
        this.jobLauncher = jobLauncher;
        this.jobName = stepInterfaceJob;
